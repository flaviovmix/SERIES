...
| 6 | O card vira componente, com a lupa e o painel das séries | em andamento, 6.4 de 11: 6.0 a 6.3 ✅ 15/09 (gerador provado e os três hubs migrados, 🟠 falta o dono no navegador); o dono pediu execução em sequência até a 6.10 (menos a 6.7), com a validação no navegador junta no fim | 15/09/2026 |
