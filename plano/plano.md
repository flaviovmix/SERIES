...
| 6 | O card vira componente, com a lupa e o painel das séries | em andamento, 6.3 de 11: 6.0, 6.1 e 6.2 ✅ 15/09 (gerador provado no `hardware.html`, 🟠 falta o dono no navegador); o dono pediu execução em sequência até a 6.10 (menos a 6.7), com a validação no navegador junta no fim | 15/09/2026 |
