...
| 6 | O card vira componente, com a lupa e o painel das séries | em andamento, 11 de 11 subetapas ✅ 15/09 (as 15 páginas com cards gerados, a D4 com trava no deploy e prova por script, o estado das séries no `series.json` e o painel local; 🟠 falta o dono no navegador). Pro "pronto quando" da etapa faltam o deploy (a 4.1 e a ordem do dono) e as 5 fotos sem crédito (P10); o dono pediu execução em sequência até a 6.10 (menos a 6.7), com a validação no navegador junta no fim | 15/09/2026 |
