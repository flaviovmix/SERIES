...
| 6 | O card vira componente, com a lupa e o painel das séries | em andamento, 11 de 11 subetapas ✅ 15/09, validadas pelo dono no navegador em 16/09 (as 15 páginas com cards gerados, a D4 com trava no deploy e prova por script, o estado das séries no `series.json` e o painel). Pro "pronto quando" da etapa faltam o deploy (pela 4.1, por ordem do dono) e as 9 fotos sem crédito (P10) | 16/09/2026 |
